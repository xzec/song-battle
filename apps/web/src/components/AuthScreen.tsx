    ...
    <div className="flex min-h-screen items-center justify-center px-6 py-16">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-zinc-950/60 p-10 shadow-2xl backdrop-blur-xl">
        ...
        <p className="mt-3 text-white/70">
          We use your Spotify account to pull in the tracks and playlists you love. No passwords are stored, everything
        ...
        <p className="mt-6 text-white/40 text-xs">
          By continuing you agree to let Song Battle access your Spotify profile &amp; playlists to build the bracket.
...
const SpotifyIcon = ({ className = 'h-6 w-6', ...props }: React.SVGProps<SVGSVGElement>) => (
